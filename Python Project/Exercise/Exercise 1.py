...
# # * Exercise 1: Calculate the multiplication and sum of two numbers Given
# two integer numbers. write a Python code to return their product only if
...
# # * Exercise 3: Print characters present at an even index number ? Write a
# Python code to accept a string from the user and display characters
...
# # * Exercise 4: Remove first `n` characters from a string ? Write a Python
# code to remove characters from a string from 0 to n and return a new string.

def first_n(text, slicing):
    return text[slicing:]


# # * Exercise 5: Check if the first and last numbers of a list are the same
# ? Write a code to return "True" if the list’s first and last numbers are
