...
class App(tk.Tk):
    def __init__(self):
        ...
        self.label_1 = tk.Label(master=self.my_frame, text="Klik Kiri")
        self.label_2 = tk.Label(master=self.my_frame, text="Klik Kanan")
        self.label_3 = tk.Label(master=self.my_frame, text="Klik Tengah")
        self.label_4 = tk.Label(master=self.my_frame, text="Pergerakan Mouse")
