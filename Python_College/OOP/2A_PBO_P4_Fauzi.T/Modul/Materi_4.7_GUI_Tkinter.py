...
class App(tk.Tk):
    def __init__(self):
        ...
        self.label_1 = tk.Label(master=self.my_frame, text="Keyboard Events (Key Pressed)")
        self.label_2 = tk.Label(master=self.my_frame, text="Keyboard Events (Key Released)")
