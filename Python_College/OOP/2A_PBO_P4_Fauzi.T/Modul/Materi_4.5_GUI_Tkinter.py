...
class App(tk.Tk):
    def __init__(self):
        ...
        self.myLabel = tk.Label(self, text="Click a Button")
        ...
        self.grup_rabu = tk.IntVar(value=2)

        self.my_radio_button_1 = tk.Radiobutton(
            master=self.my_frame,
            text="Berwarna",
        ...
        self.my_radio_button_2 = tk.Radiobutton(
            master=self.my_frame,
            text="Tidak Berwarna",
            command=self.aksi_rabu,
            variable=self.grup_rabu,
