...
class App(ttk.Window):
    def __init__(self):
        ...
        self.label_1 = ttk.Label(master=self.my_frame, text="Klik Kiri")
        self.label_2 = ttk.Label(master=self.my_frame, text="Klik Kanan")
        self.label_3 = ttk.Label(master=self.my_frame, text="Klik Tengah")
        self.label_4 = ttk.Label(master=self.my_frame, text="Pergerakan Mouse")
