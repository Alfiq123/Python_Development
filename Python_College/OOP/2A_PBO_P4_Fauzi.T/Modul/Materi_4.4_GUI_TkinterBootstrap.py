...
class App(ttk.Window):
    def __init__(self):
        ...
        self.my_label_1 = ttk.Label(master=self, text="Widget 1", background="cyan")
        self.my_label_2 = ttk.Label(master=self, text="Widget 2", background="magenta")
        self.my_label_3 = ttk.Label(master=self, text="Widget 3", background="yellow")
