...
class Aplikasi:
    def __init__(self):
        ...
        # Sandwich
        self.tombol_sandwich = ttk.Button(
            master=self.frame_2,
            text="Sandwich",
            width=8,
